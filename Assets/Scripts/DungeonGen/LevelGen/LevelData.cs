...
namespace DungeonGen
{
  ...
  public class LevelSchema
  {
    ...
    public int randomPathProbability { get; }
    public float doorChanceOnRoomOverlap { get; }

    public LevelSchema(int minRooms, int maxRooms, Vector3Int minRoomSize, Vector3Int maxRoomSize, int doorWidth, int doorHeight, int pathWidthMin, int pathWidthMax, int pathHeightMin, int pathHeightMax, int randomPathProbability, float doorChanceOnRoomOverlap)
    {
      ...
      this.randomPathProbability = randomPathProbability;
